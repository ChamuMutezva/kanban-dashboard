...
export function CreateBoardDialog({ open, onOpenChange }: Readonly<CreateBoardDialogProps>) {
  ...
  return (
    <CustomDialog open={open} onOpenChange={onOpenChange}>
      <CustomDialogContent className="sm:max-w-[425px]">
        <CustomDialogHeader>
          <CustomDialogTitle>Create New Board</CustomDialogTitle>
          <CustomDialogDescription>Create a new board to organize your tasks.</CustomDialogDescription>
        </CustomDialogHeader>
