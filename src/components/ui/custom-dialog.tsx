    ...
    <CustomDialogPortal>
        ...
        >
            ...
            <DialogPrimitive.Close
                ...
                onClick={(e) => e.stopPropagation()} // Stop propagation on the close button
            >
                <X className="h-4 w-4" />
